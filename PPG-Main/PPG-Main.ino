...
#define SSID "MY_INTERNET_2GEXT"     // "SSID-WiFiname" 
#define PASS "Nutgrove37"       // "password"
#define IP "184.106.153.149"// thingspeak.com ip

String msg = "GET /update?key=UKOEUS8UIZOU0XAJ"; //change it with your api key like "GET /update?key=Your Api Key"
String channelID = "400166";
...
void updatebeat() {
  ...
  esp8266.println(cmd);
  delay(2000);
  if(esp8266.find((const char) "Error")) {
    return;
  }
  cmd = msg ;
  cmd += "&field1=";   
